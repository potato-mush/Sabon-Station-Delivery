...
echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        // Get user image
        $userSql = "SELECT image FROM users WHERE id='$userId'"; 
        ...
        if($loggedin){
          ...
          <div class="text-center image-size-small position-relative">
            <a href="viewProfile.php"><img src="img/' .$row['image']. '" class="rounded-circle" onError="this.src = \'img/profilePic.jpg\'" style="width:40px; height:40px"></a>
          </div>';
        }
        else {
          echo '
