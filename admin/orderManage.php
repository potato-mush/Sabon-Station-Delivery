                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<tr>
                                ...
                                <td>' . $orderDate . '</td>
                                <td>
                                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#orderStatus' . $orderId . '">
                                        <i class="material-icons">visibility</i>
                                    </button>
                                </td>
                                <td>
                                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#orderItem' . $orderId . '">
