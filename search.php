        ...
        <div class="container my-3">
            ...
            <?php 
                ...
                while($row = mysqli_fetch_assoc($result)){
                    ...
                    $catImage = $row['image']; // Get category image path
                    
                    echo '<div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="card" style="width: 18rem;">
                            <img src="img/' . $catImage . '" class="card-img-top" alt="' . $catname . '" width="249px" height="270px">
                            <div class="card-body">
        ...
        <div class="container my-3">
            ...
            <?php 
                ...
                while($row = mysqli_fetch_assoc($result)){
                    ...
                    $productImage = $row['image']; // Get product image path
